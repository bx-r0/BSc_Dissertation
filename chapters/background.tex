...
\comments{Talk here about how the sliding window works and how packets can be send back and forth}


\subsubsection{Closing a connection}
\comments{Talk here about the different ways a connection can be closed}
