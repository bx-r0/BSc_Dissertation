Slow start (See ~\ref{ref:slowstart} is used to slowly ramp up the congestion window size until a suitable level is found. The most recent RFC 5681 \citep{allman2009tcp} that defines the Slow Start mechanism defines the behaviour as:
